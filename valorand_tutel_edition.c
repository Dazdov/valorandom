...
#include <time.h>
#include <string.h>
#define NUM_OF_PRIMARY 17
#define NUM_OF_SHIELDS 2
...
input: none
output: num between 0 and 18
*/
int primaries()
{
    int randomnumber = rand() % (NUM_OF_PRIMARY - 0 + 1);
    return randomnumber;
}
...
int shields()
{
    int randomnumber = rand() % (NUM_OF_SHIELDS- 0 + 1);
    return randomnumber;
}
